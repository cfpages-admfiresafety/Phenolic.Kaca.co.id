---
article_id: PTC-10-04
title: "Checklist Tender Cubicle Toilet dan Hardware"
slug: "checklist-tender-cubicle-toilet"
...
final_route: "/artikel/checklist-tender-cubicle-toilet.html"
...
# Checklist Tender Cubicle Toilet dan Hardware

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Tender Cubicle Toilet dan Hardware”
...
- **Scope boundary:** Tender completeness; bid comparison is PTC-15-02
- **Final public route:** `/artikel/checklist-tender-cubicle-toilet.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Tender Cubicle Toilet dan Hardware**.
...
- `PTC-10-03` → `/artikel/spesifikasi-cubicle-berbasis-kinerja.html` — Menulis Spesifikasi Cubicle Berbasis Kinerja
- `PTC-10-05` → `/artikel/koordinasi-gambar-cubicle-mep.html` — Koordinasi Gambar Cubicle dengan Arsitektur dan MEP
- `PTC-10-06` → `/artikel/submittal-cubicle-toilet.html` — Submittal Cubicle: Sampel, Data Teknis, dan Shop Drawing
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Tender Cubicle Toilet dan Hardware”.
