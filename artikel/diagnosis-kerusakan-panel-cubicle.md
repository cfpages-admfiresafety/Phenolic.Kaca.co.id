---
article_id: PTC-13-04
title: "Panel Mengembang, Retak, atau Delaminasi: Data yang Harus Dicatat"
slug: "diagnosis-kerusakan-panel-cubicle"
description: "Maintain hygiene and respond to damage or aging"
status: outline
...
final_route: "/artikel/diagnosis-kerusakan-panel-cubicle.html"
...
# Panel Mengembang, Retak, atau Delaminasi: Data yang Harus Dicatat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Panel Mengembang, Retak, atau Delaminasi: Data yang Harus Dicatat”
- **Reader and situation:** Maintain hygiene and respond to damage or aging
- **Reader outcome:** Maintain hygiene and respond to damage or aging
...
- **Scope boundary:** No causal claim without product and moisture review
- **Final public route:** `/artikel/diagnosis-kerusakan-panel-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panel Mengembang, Retak, atau Delaminasi: Data yang Harus Dicatat**.
...
- `PTC-13-02` → `/artikel/diagnosis-pintu-cubicle-seret.html` — Engsel Turun, Pintu Seret, dan Gap Berubah: Cara Mendiagnosis
- `PTC-13-03` → `/artikel/diagnosis-kunci-cubicle-macet.html` — Kunci dan Indikator Cubicle Macet: Pemeriksaan Awal
- `PTC-13-05` → `/artikel/jadwal-inspeksi-cubicle-toilet.html` — Jadwal Inspeksi Berkala Cubicle Toilet
- `PTC-13-06` → `/artikel/kapan-mengganti-cubicle-toilet.html` — Kapan Hardware, Panel, atau Seluruh Cubicle Perlu Diganti
...
- **Tie back to this article:** Keep the explanation specific to “Panel Mengembang, Retak, atau Delaminasi: Data yang Harus Dicatat”.
