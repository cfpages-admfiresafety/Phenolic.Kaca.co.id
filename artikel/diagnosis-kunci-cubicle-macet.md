---
article_id: PTC-13-03
title: "Kunci dan Indikator Cubicle Macet: Pemeriksaan Awal"
slug: "diagnosis-kunci-cubicle-macet"
...
final_route: "/artikel/diagnosis-kunci-cubicle-macet.html"
...
# Kunci dan Indikator Cubicle Macet: Pemeriksaan Awal

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kunci dan Indikator Cubicle Macet: Pemeriksaan Awal”
...
- **Scope boundary:** Hardware triage; no unsafe forced opening advice
- **Final public route:** `/artikel/diagnosis-kunci-cubicle-macet.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kunci dan Indikator Cubicle Macet: Pemeriksaan Awal**.
...
- `PTC-13-01` → `/artikel/cara-membersihkan-cubicle-phenolic.html` — Cara Membersihkan Panel Phenolic dan Hardware Cubicle
- `PTC-13-02` → `/artikel/diagnosis-pintu-cubicle-seret.html` — Engsel Turun, Pintu Seret, dan Gap Berubah: Cara Mendiagnosis
- `PTC-13-04` → `/artikel/diagnosis-kerusakan-panel-cubicle.html` — Panel Mengembang, Retak, atau Delaminasi: Data yang Harus Dicatat
...
- **Tie back to this article:** Keep the explanation specific to “Kunci dan Indikator Cubicle Macet: Pemeriksaan Awal”.
