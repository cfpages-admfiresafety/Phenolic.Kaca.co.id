---
article_id: PTC-11-03
title: "Menilai Kualitas Potongan, Lubang, dan Tepi Panel"
slug: "kualitas-fabrikasi-panel-cubicle"
...
final_route: "/artikel/kualitas-fabrikasi-panel-cubicle.html"
...
# Menilai Kualitas Potongan, Lubang, dan Tepi Panel

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Menilai Kualitas Potongan, Lubang, dan Tepi Panel”
...
- **Scope boundary:** Acceptance criteria require agreed specification
- **Final public route:** `/artikel/kualitas-fabrikasi-panel-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menilai Kualitas Potongan, Lubang, dan Tepi Panel**.
...
- `PTC-11-01` → `/artikel/cutting-list-panel-phenolic.html` — Cutting List Panel Phenolic yang Mengurangi Salah Potong
- `PTC-11-02` → `/artikel/isi-shop-drawing-cubicle.html` — Shop Drawing Cubicle Toilet: Isi Minimum sebelum Produksi
- `PTC-11-04` → `/artikel/penomoran-panel-hardware-cubicle.html` — Penomoran Panel dan Hardware untuk Instalasi Cepat
...
- **Tie back to this article:** Keep the explanation specific to “Menilai Kualitas Potongan, Lubang, dan Tepi Panel”.
